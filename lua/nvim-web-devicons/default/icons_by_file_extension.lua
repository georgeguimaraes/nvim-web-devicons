return {
  ...
  ["eex"]            = { icon = "", color = "#8847B9", cterm_color = "97",  name = "Eex"                        },
  ...
  ["ex"]             = { icon = "", color = "#8847B9", cterm_color = "97",  name = "Ex"                         },
  ["exe"]            = { icon = "", color = "#9F0500", cterm_color = "124", name = "Exe"                        },
  ["exs"]            = { icon = "", color = "#8847B9", cterm_color = "97",  name = "Exs"                        },
  ...
  ["heex"]           = { icon = "", color = "#8847B9", cterm_color = "97",  name = "Heex"                       },
  ...
  ["leex"]           = { icon = "", color = "#8847B9", cterm_color = "97",  name = "Leex"                       },
