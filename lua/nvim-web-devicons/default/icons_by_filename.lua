return {
  ...
  [".clang-format"]              = { icon = "", color = "#97C3E6", cterm_color = "153", name = "ClangConfig"              },
  [".clang-tidy"]                = { icon = "", color = "#97C3E6", cterm_color = "153", name = "ClangConfig"              },
  [".clangd"]                    = { icon = "", color = "#97C3E6", cterm_color = "153", name = "ClangConfig"              },
  ...
  ["mix.lock"]                   = { icon = "", color = "#8847B9", cterm_color = "97",  name = "MixLock"                  },
  ...
  ["taskfile.dist.yaml"]         = { icon = "󰆦", color = "#69D3C9", cterm_color = "80",  name = "TaskfileConfig"           },
  ["taskfile.dist.yml"]          = { icon = "󰆦", color = "#69D3C9", cterm_color = "80",  name = "TaskfileConfig"           },
  ["taskfile.yaml"]              = { icon = "󰆦", color = "#69D3C9", cterm_color = "80",  name = "TaskfileConfig"           },
  ["taskfile.yml"]               = { icon = "󰆦", color = "#69D3C9", cterm_color = "80",  name = "TaskfileConfig"           },
  ...
  ["vite.config.cjs"]            = { icon = "", color = "#8040FF", cterm_color = "93",  name = "ViteConfig"               },
  ["vite.config.cts"]            = { icon = "", color = "#8040FF", cterm_color = "93",  name = "ViteConfig"               },
  ["vite.config.js"]             = { icon = "", color = "#8040FF", cterm_color = "93",  name = "ViteConfig"               },
  ["vite.config.mjs"]            = { icon = "", color = "#8040FF", cterm_color = "93",  name = "ViteConfig"               },
  ["vite.config.mts"]            = { icon = "", color = "#8040FF", cterm_color = "93",  name = "ViteConfig"               },
  ["vite.config.ts"]             = { icon = "", color = "#8040FF", cterm_color = "93",  name = "ViteConfig"               },
