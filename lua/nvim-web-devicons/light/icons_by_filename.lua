return { -- this file is generated from lua/nvim-web-devicons/default/icons_by_filename.lua, please do not edit
  ...
  [".clang-format"]              = { icon = "", color = "#4C6273", cterm_color = "24",  name = "ClangConfig"              },
  [".clang-tidy"]                = { icon = "", color = "#4C6273", cterm_color = "24",  name = "ClangConfig"              },
  [".clangd"]                    = { icon = "", color = "#4C6273", cterm_color = "24",  name = "ClangConfig"              },
  ...
  ["bitbucket-pipelines.yml"]    = { icon = "󰂨", color = "#1C63BF", cterm_color = "25",  name = "BitbucketPipelinesConfig" },
  ...
  ["mix.lock"]                   = { icon = "", color = "#66358B", cterm_color = "90",  name = "MixLock"                  },
  ...
  ["taskfile.dist.yaml"]         = { icon = "󰆦", color = "#346A64", cterm_color = "23",  name = "TaskfileConfig"           },
  ["taskfile.dist.yml"]          = { icon = "󰆦", color = "#346A64", cterm_color = "23",  name = "TaskfileConfig"           },
  ["taskfile.yaml"]              = { icon = "󰆦", color = "#346A64", cterm_color = "23",  name = "TaskfileConfig"           },
  ["taskfile.yml"]               = { icon = "󰆦", color = "#346A64", cterm_color = "23",  name = "TaskfileConfig"           },
  ...
  ["vite.config.cjs"]            = { icon = "", color = "#6030BF", cterm_color = "56",  name = "ViteConfig"               },
  ["vite.config.cts"]            = { icon = "", color = "#6030BF", cterm_color = "56",  name = "ViteConfig"               },
  ["vite.config.js"]             = { icon = "", color = "#6030BF", cterm_color = "56",  name = "ViteConfig"               },
  ["vite.config.mjs"]            = { icon = "", color = "#6030BF", cterm_color = "56",  name = "ViteConfig"               },
  ["vite.config.mts"]            = { icon = "", color = "#6030BF", cterm_color = "56",  name = "ViteConfig"               },
  ["vite.config.ts"]             = { icon = "", color = "#6030BF", cterm_color = "56",  name = "ViteConfig"               },
